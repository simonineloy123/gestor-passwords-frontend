...
export default function PasswordsPage() {
  ...
  const handleAdd = () => { setSelectedRecord(null); setIsPasswordModalOpen(true); };
  const handleEdit = (record: PasswordRecord) => { setSelectedRecord(record); setIsPasswordModalOpen(true); };
  const handleDeleteClick = (record: PasswordRecord) => { setSelectedRecord(record); setIsDeleteModalOpen(true); };
    ...
    <div className="flex flex-col gap-6 max-w-6xl">
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-0.5">
          <h1 className="text-xl font-semibold tracking-tight">Mis Contraseñas</h1>
